# Élevages Leaders - Plateforme Web E-commerce

Bienvenue sur le dépôt du code source de l'application web **Élevages Leaders**. Ce projet est une solution complète (Site Vitrine + E-commerce + Administration) développée avec des technologies modernes pour assurer performance et évolutivité.
...
| :--- | :--- | :--- | :--- |
| **Administrateur** | `admin@elevagesleaders.cm` | `admin123` | **OTP : 2025** |
| **Utilisateur** | `user@elevagesleaders.cm` | `user123` | |
...
*   **Contact :** contact@elevagesleaders.cm